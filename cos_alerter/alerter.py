...
class AlerterState:
    ...
    def __enter__(self):
        ...
        """
        logging.debug("Acquiring lock for state file.")
    ...
    def __exit__(self, _, __, ___):
        ...
        """
        logging.debug("Writing state file.")
        self.fh.seek(0)
        json.dump(self.data, self.fh)
        self.fh.truncate()
        logging.debug("Releasing lock for state file.")
    ...
    def initialize():
        ...
        threads running.
        """
        logging.info("Initializing COS Alerter.")
    ...
    def reset_alert_timeout(self):
        ...
        logging.debug("Resetting alert timeout.")
    ...
    def notify(self):
        ...
        if self._recently_notified():
            logging.debug("Recently notified. Skipping.")
            return
...
def send_test_notification():
    ...
    logging.info("Sending test notifications.")
    send_notifications(
